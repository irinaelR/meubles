...
CREATE OR REPLACE VIEW FORMULEAVECSTYLECATEGORIE AS (
    SELECT
        TAILLEPARCATEGORIEPARSTYLE.IDTC,TAILLEPARCATEGORIEPARSTYLE.IDCATEGORIE, TAILLEPARCATEGORIEPARSTYLE.IDSTYLE, TAILLEPARCATEGORIEPARSTYLE.IDVOLUME,
...
CREATE OR REPLACE VIEW PRODUIT AS (
    SELECT
        TAILLEPARCATEGORIEPARSTYLE.IDTC,TAILLEPARCATEGORIEPARSTYLE.IDSTYLE, TAILLEPARCATEGORIEPARSTYLE.IDCATEGORIE, TAILLEPARCATEGORIEPARSTYLE.IDVOLUME,
